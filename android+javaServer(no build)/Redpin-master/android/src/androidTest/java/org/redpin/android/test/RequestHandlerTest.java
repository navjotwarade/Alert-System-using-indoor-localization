...
public class RequestHandlerTest extends InstrumentationTestCase {
    ...
    public void test_mapRequest() {
        ...
        Request<Map> request = new Request<>(RequestType.setMap, map);
        ...
        request = new Request<>(RequestType.removeMap, map);
    ...
    public void test_getMapListRequest() {
        ...
        ConnectionHandler.host = real_localhost;
        ConnectionHandler.port = port;
        Request<Map> request = new Request<>(RequestType.getMapList);
        // assertEquals(new TypeToken<Response<Map>>() {}.getType(),
        // setMapRequest.getResponseType());
    ...
    public void test_setFingerprintRequest() {
        ...
        Request<Map> mrequest = new Request<>(RequestType.setMap, map);
        ...
        Request<Fingerprint> request = new Request<>(
        ...
        Request<Map> mmrequest = new Request<>(RequestType.removeMap, map);
