...
public class ZoomAndScrollImageView extends View implements OnZoomListener,
    ...
    class ZoomAndTranslate extends Animation {
        ...
        protected void applyTransformation(float interpolatedTime,
            ...
            float zInterpolatedTime = zoomInterpolator.getInterpolation(interpolatedTime);
    ...
    public interface ZoomAndScrollViewListener {
         ...
         */
        void onMatrixChange(Matrix m, ZoomAndScrollImageView view);
         ...
         *            View that calls the method
         */
        void onScaleBegin(ZoomAndScrollImageView view);
         ...
         *            View that calls the method
         */
        void onScaleEnd(ZoomAndScrollImageView view);
