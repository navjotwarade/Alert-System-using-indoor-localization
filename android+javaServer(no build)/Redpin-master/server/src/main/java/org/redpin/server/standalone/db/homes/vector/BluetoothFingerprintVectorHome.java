...
public class BluetoothFingerprintVectorHome extends VectorHome<BluetoothFingerprint> {

	private static final String className = BluetoothFingerprint.class.getSimpleName();
	 ...
	 */
	@Override
	public EntityHome<BluetoothFingerprint> getObjectHome() {
		return HomeFactory.getBluetoothFingerprintHome();
	}
