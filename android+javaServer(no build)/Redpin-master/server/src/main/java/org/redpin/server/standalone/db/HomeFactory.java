...
import org.redpin.server.standalone.db.homes.BluetoothFingerprintHome;
...
import org.redpin.server.standalone.db.homes.vector.BluetoothFingerprintVectorHome;
...
public class HomeFactory {
	...
	private static BluetoothFingerprintHome bfpHome = null;
	public synchronized static BluetoothFingerprintHome getBluetoothFingerprintHome() {
		if(bfpHome == null) {
			bfpHome = new BluetoothFingerprintHome();
		}		
		return bfpHome;
	}
	
	private static BluetoothFingerprintVectorHome bfpvHome = null;
	public synchronized static BluetoothFingerprintVectorHome getBluetoothFingerprintVectorHome() {
		if(bfpvHome == null) {
			bfpvHome = new BluetoothFingerprintVectorHome();
		}		
		return bfpvHome;
	}
