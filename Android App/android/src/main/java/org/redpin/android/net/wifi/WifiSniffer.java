...
public class WifiSniffer extends Service {
    ...
    private final BroadcastReceiver mResultReceiver = new BroadcastReceiver() {
        ...
        @Override
        public void onReceive(Context context, Intent intent) {
            System.out.println("wifi scan start time: "+System.currentTimeMillis() % 1000);
            ...
            for (ScanResult result : results) {
                if(result.SSID.contains("SJSU")|| result.SSID.contains("Trojan") ) {
           ...
           // BluetoothReading reading = new BluetoothReading();
            ...
            System.out.println("wiscan stop time: "+System.currentTimeMillis() % 1000);
