...
public class MapViewActivity extends Activity {
    ...
    int ble1Count, ble1rssi;
    int ble2Count, ble2rssi;
    int ble3Count, ble3rssi;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                System.out.println("add location start time: "+System.currentTimeMillis() % 1000);
                addNewLocation();
            }
        });
        ...
        locateButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                System.out.println("locate start time: "+System.currentTimeMillis() % 1000);
                locate();
            }
        });
    ...
    private void locate() {
      ...
      /*  Timer myTimer;
        ...
        myTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                displayListOfFoundDevices();//your method
            }
...
*/
          ...
          //  m.addBluetoothReading(new BluetoothReading());
            ...
            if(!arrayOfFoundBTDevices.isEmpty()) {
                ...
                for (BluetoothObject bObject : arrayOfFoundBTDevices) {
                    ...
                    String[] bObj = new String[3];
                    bObj[0]=bObject.getBluetooth_name();
                    bObj[1]=bObject.getBluetooth_address();
                    bObj[2]=String.valueOf(bObject.getBluetooth_rssi());
                    String bOString =bObj[0]+","+bObj[1]+","+bObj[2];
                    if(l.contains(bOString)){
                        continue;
                    }
                    l.add(bOString);
                    //   reading.
                ...
                /*String[] array = new String[arrayOfFoundBTDevices.size()];
                int index = 0;
                for (BluetoothObject value : arrayOfFoundBTDevices) {
                    array[index] = value.toString();
                    index++;
                }
                System.out.println(array.toString());*/
                l.add(", ");
                new HttpCaller().execute(l.toString());
                l.clear();
            ...
            if (mLocation != null) {
                ...
                FingerprintRemoteHome.setFingerprint(fp,
                        new RemoteEntityHomeCallback() {
                            ...
                            public void onResponse(Response<?> response) {
                                System.out.println("setFingerprint response time: "+System.currentTimeMillis() % 1000);
                                if (firstMeasurement) {
                                    progressDialog.hide();
                            ...
                            public void onFailure(Response<?> response) {
                                System.out.println("setFingerprint fail time: "+System.currentTimeMillis() % 1000);
                                progressDialog.hide();
                                Log.i(TAG,
                ...
                LocationRemoteHome.getLocation(m,
                        new RemoteEntityHomeCallback() {
                            ...
                            public void onResponse(Response<?> response) {
                                progressDialog.hide();
                                System.out.println("locate response time: " + System.currentTimeMillis() % 1000);
    ...
    private void displayListOfFoundDevices()
    {
        ...
        System.out.println("bluetooth scan start time: "+System.currentTimeMillis() % 1000);
             ...
             //    bluetoothObject.setBluetooth_type(device.getType());    // requires API 18 or higher
              //  bluetoothObject.setBluetooth_uuids(device.getUuids());
               ...
               // device.
                ...
                System.out.println("rssi:" + rssi + "name:" + device.getName());
                if(device.getName()!=null) {
                    if (device.getName().equals("NAV")) {
                        devicename = device.getName();
                        devicerssi = rssi;
                        ble1rssi += devicerssi;
                        ble1Count++;
                        ble1rssi = ble1rssi/ble1Count;
                      //  new HttpCaller().execute(devicename + "," + devicerssi);
                    }
                    else if (device.getName().equals("HOMEPC")) {
                        devicename = device.getName();
                        devicerssi = rssi;
                        ble2rssi += devicerssi;
                        ble2Count++;
                        ble2rssi = ble2rssi/ble2Count;
                      //  new HttpCaller().execute(devicename + "," + devicerssi);
                    }
                    else if (device.getName().equals("MotoG3")) {
                        devicename = device.getName();
                        devicerssi = rssi;
                        ble3rssi += devicerssi;
                        ble3Count++;
                        ble3rssi = ble3rssi/ble3Count;
                     //   new HttpCaller().execute(devicename + "," + devicerssi);
                    }
                   // new HttpCaller().execute(ble1rssi + "," + ble2rssi+ "," +ble3rssi);
                }
                ...
                System.out.println("Blluetooth inside scan end time: "+System.currentTimeMillis() % 1000);
            }
        }
    };
        System.out.println("Blluetooth scan end time: "+System.currentTimeMillis() % 1000);
