...
public class RemoteEntityHomeTest extends
    ...
    public void test_setMap() {
        ...
        Request<Void> mockRequest = new Request<>(RequestType.setMap);
        Response<Map> mockResponse = new Response<>(Status.ok, map);
        map.setRemoteId(10);
    ...
    public void test_getMapList() {
        ...
        Request<Void> mockRequest = new Request<>(RequestType.getMapList);
    ...
    public void test_removeMap() {
        ...
        Request<Map> mockRequest = new Request<>(RequestType.removeMap, map);
        Response<Void> mockResponse = new Response<>(Status.ok);
    ...
    public void test_getLocation() {
        ...
        Request<Measurement> mockRequest = new Request<>(
                RequestType.getLocation);
        loc.setRemoteId(10);
        Response<Location> mockResponse = new Response<>(Status.ok, loc);
        PerformRequestTask mockTask = new PerformRequestTask();
    ...
    public void test_updateLocation() {
        ...
        Request<Location> mockRequest = new Request<>(
    ...
    public void test_getLocationList() {
        ...
        Request<Void> mockRequest = new Request<>(
    ...
    public void test_setFingerprint() {
        ...
        Request<Fingerprint> mockRequest = new Request<>(
                RequestType.setFingerprint, fingerprint);
        Response<Fingerprint> mockResponse = new Response<>(
        ...
        mockRequest = new Request<>(RequestType.setFingerprint,
                fingerprint);
        mockResponse = new Response<>(Status.ok, fingerprintCopy);
    ...
    public void test_onSuccess() {
        ...
        map.setRemoteId(20);
        Request<Map> mockRequest = new Request<>(RequestType.setMap, map);
        Response<Map> mockResponse = new Response<>(Status.ok, map);
    ...
    public void test_CallbackOnSuccess() {
        ...
        map.setRemoteId(20);
        Request<Map> mockRequest = new Request<>(RequestType.setMap, map);
        mockResponse = new Response<>(Status.ok, map);
